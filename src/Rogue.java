...
public class Rogue extends Character {
    ...
    public Rogue(ArrayList<Spell> abilities, int max_life, int max_mana, boolean fire_protection, boolean ice_protection, boolean earth_protection, String name, int ox, int oy, int current_experience, int level) {
    ...
    public void recieveDamage(int damage) {
        ...
        if(strength > 10 && charisma > 20 && chance > 50)
